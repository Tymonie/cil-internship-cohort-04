...
<body>
 ...
 <section class="navbar">
  ...
  <!-- This contains the first section for the home page -->
  ...
  <!-- This contains the second section for the home page -->
  ...
  <!-- This contains the third section for the home page -->
       <section class="home3">
  ...
  <!-- This contains the fourth section for the home page -->
         <section class="home4">
  ...
  <!-- This contains the fifth section for the home page -->
  <section class="home5">
  ...
  <!-- This contains the first section for the about page -->
  ...
  <section class="about" id="about-us">
   ...
   <!-- This contains the second section for the about page -->
